exports.create = ()=>{
  ...
  const formSpeciality = new TextInput({
      id:'',
      left: 15,
      right: 15,
      top:180,
      height:50,
      message:language.chooseAProfilePage.userForm[14],
      textColor:appBasicsInformations.color.color1,
      borderColor:appBasicsInformations.color.color3
  }).appendTo(connectionComposite);
  const items = language.userSignUpForm.code;
  const formCode = new TextInput({
      id:'',
      left: 15,
      right: 15,
      top:230,
      ...
      borderColor:appBasicsInformations.color.color3,
      textColor:appBasicsInformations.color.color1,
      message:language.chooseAProfilePage.userForm[13],
  }).appendTo(connectionComposite);
